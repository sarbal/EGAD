...
#' @export
#'
plot_density_compare <- function(aucA, aucB, col = "lightgrey", xlab = "AUC (neighbor voting)", ylab = "Density", 
    mode = TRUE) {
    ...
    plot(0, 0, col = 0, xlim = xlim, ylim = ylim, xlab = xlab, ylab = ylab, bty = "n", cex.lab = 1.5, cex.axis = 1.2)
